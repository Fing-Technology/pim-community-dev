...
- Change the constructor of `Pim\Bundle\VersioningBundle\Normalizer\Flat\AttributeOptionNormalizer` to add `Symfony\Component\Serializer\Normalizer\NormalizerInterface`
...
- Change the constructor of `Pim\Bundle\VersioningBundle\Normalizer\Flat\CollectionNormalizer` to add `Symfony\Component\Serializer\Normalizer\NormalizerInterface`
...
- Change the constructor of `Pim\Bundle\VersioningBundle\Normalizer\Flat\JobInstanceNormalizer` to add `Symfony\Component\Serializer\Normalizer\NormalizerInterface`
...
- Change the constructor of `Pim\Bundle\VersioningBundle\Normalizer\Flat\ProductNormalizer` to remove `Pim\Bundle\CatalogBundle\Filter\CollectionFilterInterface` and add `Symfony\Component\Serializer\Normalizer\NormalizerInterface`
- Change the constructor of `Pim\Bundle\VersioningBundle\Normalizer\Flat\ProductValueNormalizer` to remove `Pim\Component\Catalog\Localization\Localizer\LocalizerRegistryInterface` and add `Symfony\Component\Serializer\Normalizer\NormalizerInterface`
